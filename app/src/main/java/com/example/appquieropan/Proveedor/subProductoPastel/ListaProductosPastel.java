...
import com.example.appquieropan.Adaptadores.Proveedor.RecyclerProductoPastel;
...
public class ListaProductosPastel extends AppCompatActivity implements View.OnClickListener{

    public static final String codigoProvve="id";
    private String userP = null;
    private String rutEmpresa = null;

    private RecyclerProductoPastel recyclerProductosAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_productos_pastel);


        mDatabase = FirebaseDatabase.getInstance().getReference();

        btnAgregarProd= findViewById(R.id.imgSinProductosPastel);
        btnAgregarProd.setOnClickListener(this);

        userP = getIntent().getStringExtra("id");

        mRecyclerView = findViewById(R.id.myRecyclerPPastel);
        ...
        botonesNav = findViewById(R.id.botones_navegPastel);
        ...
        botonesNav.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if (menuItem.getItemId()==R.id.nav_home){
                    ...
                    Intent intent = new Intent(ListaProductosPastel.this, homeProveedor.class);
                    ...
                    Intent intent = new Intent(ListaProductosPastel.this, PerfilProveedor.class);
                    ...
                    Intent intent = new Intent(ListaProductosPastel.this, facturasProveedor.class);
                    ...
                    Intent intent = new Intent(ListaProductosPastel.this, opcionesSegmentoProveedor.class);
                    ...
                    //Toast.makeText(homeProveedor.this, "venta", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(ListaProductosPastel.this, tipoVenta.class);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.imgSinProductosPastel:
                Intent intentP = new Intent(this, ingresaSubProductoPastel.class);
                intentP.putExtra(ingresaSubProductoPastel.codigoProvve,userP);
                startActivity(intentP);
                Toast.makeText(this, "Presiona Pastel", Toast.LENGTH_SHORT).show();
                finish();
                break;
        }
    }
    ...
    public void CargarRecyclerView(RecyclerView recyclerView){
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference("SubProductoPastel");
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                recyclerProductosAdapter = new RecyclerProductoPastel(getApplicationContext(),R.layout.item_ventas,arrayListTipo);
