...
public class detalleProductoSeleccionadoPastel extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalle_producto_seleccionado_pastel);

        mDatabase = FirebaseDatabase.getInstance().getReference();
        storageReference = FirebaseStorage.getInstance().getReference();
        mStorage = FirebaseStorage.getInstance();

        txtEdnombre = findViewById(R.id.EdnomProductoPastel);
        txtDescripcion = findViewById(R.id.EddescProdutoPastel);
        txtPrecio = findViewById(R.id.EdidPrecioProductoPastel);
        imgProducto = findViewById(R.id.imgEditProductoPastel);

        userP = getIntent().getStringExtra("id");

        radioGroup = findViewById(R.id.radioGroup5Pastel);
        radio1 = findViewById(R.id.radioKiloPastel);
        radio2 = findViewById(R.id.radioUnidadPastel);

        btnCambiosG = findViewById(R.id.btnEditarProductoPastel);
        btnEliminar = findViewById(R.id.btnEliminarProductoPastel);
    ...
    private void actualizaFirebase(final String nombre, final String descripcion, final String precio, Uri data, final String datoRadio) {
        ...
        if (!TextUtils.isEmpty(nombre) && !TextUtils.isEmpty(descripcion) && !TextUtils.isEmpty(precio)){
            ...
            if (flagUrl == 1){
                ...
                storageReference = storageReference.child("Pastel/Subproducto/"+ nombre +"_"+ System.currentTimeMillis() +".png");
                storageReference.putFile(data)
                        .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                            ...
                            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                ...
                                Toast.makeText(detalleProductoSeleccionadoPastel.this,"Producto actualizado",Toast.LENGTH_SHORT).show();
    ...
    private void cargarDatosVistaDetalle(final String idProducto) {
        ...
        mDatabase.child("SubProductoPastel").addValueEventListener(new ValueEventListener() {
            @Override
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.imgEditProductoPastel:
                abrirFotoGaleria();
                break;
/*
            case R.id.btnEditarProducto:
                ...
                break;
*/
            case R.id.btnEditarProductoPastel:
                ...
                break;
            case R.id.btnEliminarProductoPastel:
                eliminaProductoPastel();
                break;
        }
    }

    private void eliminaProductoPastel() {
            ...
            public void onClick(DialogInterface dialogo1, int id) {
                ...
                imageAlmacenada.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        TipoSubProducto actTipo = new TipoSubProducto();
                        actTipo.setUid(getIntent().getStringExtra("idP"));
                        mDatabase.child("SubProductoPastel").child(actTipo.getUid()).removeValue();

                        Toast.makeText(detalleProductoSeleccionadoPastel.this,"Producto Eliminado",Toast.LENGTH_SHORT).show();
//                progressDialog.dismiss();
                        limpiaCampos();
                    }
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(detalleProductoSeleccionadoPastel.this, "Error al: "+ e.toString(), Toast.LENGTH_SHORT).show();
                    }
                });;
