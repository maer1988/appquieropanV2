...
public class RecyclerProveedorPan extends RecyclerView.Adapter<RecyclerProveedorPan.ProveedorViewHolder>{
    ...
    public RecyclerProveedorPan(Context mContext, int layoutResource, ArrayList<Proveedor> arrayListProveedor) {
    ...
    @NonNull
    @Override
    public RecyclerProveedorPan.ProveedorViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {

        View view = LayoutInflater.from(mContext).inflate(layoutResource, viewGroup, false);

        return new RecyclerProveedorPan.ProveedorViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final RecyclerProveedorPan.ProveedorViewHolder proveedorViewHolder, int i) {
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()){
                case R.id.btnEditPanCliente:
                    Intent intent = new Intent(mContext, SubProductoPanCliente.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    intent.putExtra(SubProductoPanCliente.rutE,mRut.getText().toString());
