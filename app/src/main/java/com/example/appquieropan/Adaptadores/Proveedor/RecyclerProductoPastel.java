...
public class RecyclerProductoPastel extends RecyclerView.Adapter<RecyclerProductoPastel.ProductoViewHolder>{
    ...
    public RecyclerProductoPastel(Context context, int layoutResource, ArrayList<TipoSubProducto> arrayListProductos) {
    ...
    @NonNull
    @Override
    public RecyclerProductoPastel.ProductoViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {

        View view = LayoutInflater.from(mCcontext).inflate(layoutResource, viewGroup, false);

        return new RecyclerProductoPastel.ProductoViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final RecyclerProductoPastel.ProductoViewHolder productoViewHolder, int i) {
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()){
                case R.id.btnEditarPan:
                    Intent intent = new Intent(mCcontext, detalleProductoSeleccionadoPastel.class);
