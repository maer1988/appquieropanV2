...
import com.example.appquieropan.Cliente.SubProductosDelProveedor.SubProductoOtrasMasasCliente;
import com.example.appquieropan.Entidad.Proveedor;
import com.example.appquieropan.R;

import java.util.ArrayList;

public class RecyclerProveedorOtrasMasa extends RecyclerView.Adapter<RecyclerProveedorOtrasMasa.ProveedorViewHolder>{
    ...
    public RecyclerProveedorOtrasMasa(Context mContext, int layoutResource, ArrayList<Proveedor> arrayListProveedor) {
    ...
    @NonNull
    @Override
    public RecyclerProveedorOtrasMasa.ProveedorViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {

        View view = LayoutInflater.from(mContext).inflate(layoutResource, viewGroup, false);

        return new RecyclerProveedorOtrasMasa.ProveedorViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final RecyclerProveedorOtrasMasa.ProveedorViewHolder proveedorViewHolder, int i) {
        ...
        Glide
                ...
                .listener(new RequestListener<Drawable>() {
                    ...
                    public boolean onLoadFailed(@Nullable GlideException e, Object model, Target<Drawable> target, boolean isFirstResource) {
                        ...
                        proveedorViewHolder.imageProveedor.setImageResource(R.drawable.ic_launcher_background);
                        return false;
                    }
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()){
                case R.id.btnEditPanCliente:
                    Intent intent = new Intent(mContext, SubProductoOtrasMasasCliente.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);

                    intent.putExtra(SubProductoOtrasMasasCliente.rutE,mRut.getText().toString());
