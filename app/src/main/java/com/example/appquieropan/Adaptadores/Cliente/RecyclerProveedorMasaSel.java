...
public class RecyclerProveedorMasaSel extends RecyclerView.Adapter<RecyclerProveedorMasaSel.ProductoViewHolder>{
    ...
    public RecyclerProveedorMasaSel(Context context, int layoutResource, ArrayList<TipoSubProducto> arrayListProductos) {
    ...
    @NonNull
    @Override
    public RecyclerProveedorMasaSel.ProductoViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {

        View view = LayoutInflater.from(mCcontext).inflate(layoutResource, viewGroup, false);

        return new RecyclerProveedorMasaSel.ProductoViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final RecyclerProveedorMasaSel.ProductoViewHolder productoViewHolder, int i) {

        Log.d("RPMS","onbindviewholder");
