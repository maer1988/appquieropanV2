...
public class RecyclerProveedorOtrasMasasSel extends RecyclerView.Adapter<RecyclerProveedorOtrasMasasSel.ProductoViewHolder>{
    ...
    public RecyclerProveedorOtrasMasasSel(Context context, int layoutResource, ArrayList<TipoSubProducto> arrayListProductos) {
    ...
    @NonNull
    @Override
    public RecyclerProveedorOtrasMasasSel.ProductoViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {

        View view = LayoutInflater.from(mCcontext).inflate(layoutResource, viewGroup, false);

        return new RecyclerProveedorOtrasMasasSel.ProductoViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final RecyclerProveedorOtrasMasasSel.ProductoViewHolder productoViewHolder, int i) {
    ...
    public  class ProductoViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ProductoViewHolder(@NonNull View itemView) {
            ...
            //tnEditar.setOnClickListener(this);
        }
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()){
                case R.id.imgSubproducto:
                    ...
                    intent.putExtra(SubProductoElegidoPan.Tabla,"SubProductoOtraMasa");
