...
import com.example.appquieropan.Cliente.SubProductosDelProveedor.SubProductoMasaCliente;
import com.example.appquieropan.Entidad.Proveedor;
import com.example.appquieropan.R;

import java.util.ArrayList;

public class RecyclerProveedorMasa extends RecyclerView.Adapter<RecyclerProveedorMasa.ProveedorViewHolder>{
    ...
    public RecyclerProveedorMasa(Context mContext, int layoutResource, ArrayList<Proveedor> arrayListProveedor) {
    ...
    @NonNull
    @Override
    public RecyclerProveedorMasa.ProveedorViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {

        View view = LayoutInflater.from(mContext).inflate(layoutResource, viewGroup, false);

        return new RecyclerProveedorMasa.ProveedorViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final RecyclerProveedorMasa.ProveedorViewHolder proveedorViewHolder, int i) {
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()){
                case R.id.btnEditPanCliente:
                    Intent intent = new Intent(mContext, SubProductoMasaCliente.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    intent.putExtra(SubProductoMasaCliente.rutE,mRut.getText().toString());
