...
public class RecyclerProductosAdapter extends RecyclerView.Adapter<RecyclerProductosAdapter.ProductoViewHolder> {
    ...
    public RecyclerProductosAdapter(Context context, int layoutResource, ArrayList<TipoSubProducto> arrayListProductos) {
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()){
                case R.id.btnEditarPan:
                    Intent intent = new Intent(mCcontext, detalleProductoSeleccionado.class);
