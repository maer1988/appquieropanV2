...
import com.example.appquieropan.Adaptadores.Cliente.RecyclerProveedorPastel;
...
public class Pastelerias extends AppCompatActivity implements View.OnClickListener{

    private RecyclerProveedorPastel recyclerProductosAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pastelerias);

        mDatabase = FirebaseDatabase.getInstance().getReference();

        mRecyclerView = findViewById(R.id.myListaPastelC);
        LinearLayoutManager layoutManager = new LinearLayoutManager(this);
        mRecyclerView.setLayoutManager(layoutManager);

        CargarRecyclerView(mRecyclerView);

        botonesNav = findViewById(R.id.botones_navegacion_pastel);
        botonesNav.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if (menuItem.getItemId()==R.id.nav_home_cliente){
                    Intent intent = new Intent(Pastelerias.this, HomeCliente.class);
        ...
        mDatabase.child("Proveedor").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot snapshot: dataSnapshot.getChildren()){
                    ...
                    mDatabase.child("Pastel_Proveedor").orderByChild("rut_empresa").equalTo(rutEmpresa).addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                            ...
                            if(dataSnapshot2.exists() == true){
                                ...
                                mDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        ...
                                        recyclerProductosAdapter = new RecyclerProveedorPastel(getApplicationContext(),R.layout.item_proveedores,arrayListTipo);
