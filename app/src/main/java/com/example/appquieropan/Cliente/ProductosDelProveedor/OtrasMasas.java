...
import com.example.appquieropan.Adaptadores.Cliente.RecyclerProveedorOtrasMasa;
...
public class OtrasMasas extends AppCompatActivity implements View.OnClickListener{

    private RecyclerProveedorOtrasMasa recyclerProductosAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_otras_masas);

        mDatabase = FirebaseDatabase.getInstance().getReference();

        mRecyclerView = findViewById(R.id.myListaOtrasMasaC);
        LinearLayoutManager layoutManager = new LinearLayoutManager(this);
        mRecyclerView.setLayoutManager(layoutManager);

        CargarRecyclerView(mRecyclerView);

        botonesNav = findViewById(R.id.botones_navegacion_otras);
        botonesNav.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if (menuItem.getItemId()==R.id.nav_home_cliente){
                    Intent intent = new Intent(OtrasMasas.this, HomeCliente.class);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot snapshot: dataSnapshot.getChildren()){
                    ...
                    if(userP.equals(proveedor.getId_proveedor())){
                        ...
                        Toast.makeText(OtrasMasas.this, "Lista ok", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        ...
        mDatabase.child("Proveedor").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot snapshot: dataSnapshot.getChildren()){
                    ...
                    mDatabase.child("OtrasMasas_Proveedor").orderByChild("rut_empresa").equalTo(rutEmpresa).addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                            ...
                            if(dataSnapshot2.exists() == true){
                                ...
                                mDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        ...
                                        recyclerProductosAdapter = new RecyclerProveedorOtrasMasa(getApplicationContext(),R.layout.item_proveedores,arrayListTipo);
