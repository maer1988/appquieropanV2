...
import com.example.appquieropan.Adaptadores.Cliente.RecyclerProveedorOtrasMasasSel;
...
public class SubProductoOtrasMasasCliente extends AppCompatActivity {
    ...
    private RecyclerProveedorOtrasMasasSel recyclerProductosAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sub_producto_otras_masas_cliente);
        ...
        mRecyclerView = findViewById(R.id.myOtrasProdCliProv);
        LinearLayoutManager layoutManager = new LinearLayoutManager(this);
        mRecyclerView.setLayoutManager(layoutManager);


        botonesNav = findViewById(R.id.botones_navegacion_otras_masas);
        botonesNav.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if (menuItem.getItemId()==R.id.nav_home_cliente){
                    Intent intent = new Intent(SubProductoOtrasMasasCliente.this, HomeCliente.class);
                    ...
                    Intent intent = new Intent(SubProductoOtrasMasasCliente.this, ListadoVoucher.class);
                    intent.putExtra(ListadoVoucher.opcion_voucher,"pendiente");
                    startActivity(intent);
                    finish();
                }
                else if(menuItem.getItemId()==R.id.nav_perfil_cliente) {
                    Intent intent = new Intent(SubProductoOtrasMasasCliente.this, PerfilCliente.class);
                    startActivity(intent);
                    finish();
                }
                else if(menuItem.getItemId()==R.id.nav_compras_cliente) {
                    //Toast.makeText(homeProveedor.this, "segmento", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(SubProductoOtrasMasasCliente.this, ListadoCarroCompra.class);
    ...
    private void cargaSubProductosDelProveedor(final String rutProveedor) {
        ...
        mDatabase.child("SubProductoOtraMasa").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                recyclerProductosAdapter = new RecyclerProveedorOtrasMasasSel(getApplicationContext(),R.layout.item_subproductos,arrayListTipo);
